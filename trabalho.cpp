...
GLfloat Xart1pata3 = 355;
GLfloat Xart2pata3 = 285;
GLfloat Yart1pata3 = 370;
GLfloat Yart2pata3 = 375;

GLfloat Xart1pata4 = 445;
GLfloat Xart2pata4 = 515;
GLfloat Yart1pata4 = 370;
GLfloat Yart2pata4 = 375;
...
void Draw() {
    ...
    glBegin(GL_POLYGON);                                                //Inicia o desenho de um poligono.
    glColor3f(1.02,0.02,0.02);                                                    //Cor do poligono.
    for (float i = 0; i < 2*PI ; i+=0.1){                                //Rotaciona os pontos do poligono para formar um circulo.
    ...
    glColor3f(0,1,0);                    //cor do triangulo
    ...
    glBegin(GL_QUADS);                //Inicia o desenho do triangulo
    glColor3f(0,0.5,0);                    //cor do triangulo
    ...
    glBegin(GL_QUADS);                //Inicia o desenho do triangulo
    glColor3f(0,0,1);                    //cor do triangulo
    ...
    /*Desenha articulação 1 da pata 3*/
    glMatrixMode(GL_MODELVIEW);            //Projeta a imagem na tela.
    glLoadIdentity();                    //Carrega MatrixMode.
    
    glBegin(GL_QUADS);                //Inicia o desenho do triangulo
    glColor3f(1,0,1);                    //cor do triangulo
    glVertex2f(Xart1pata3-40,Yart1pata3+10);            //Coordenadas dos pontos do triangulo.
    glVertex2f(Xart1pata3-40,Yart1pata3+25);
    glVertex2f(Xart1pata3+20,Yart1pata3-5);
    glVertex2f(Xart1pata3+30,Yart1pata3-25);
    glEnd();
    
    /*Desenha articulação 2 da pata 3*/
    glMatrixMode(GL_MODELVIEW);            //Projeta a imagem na tela.
    glLoadIdentity();                    //Carrega MatrixMode.
    
    glBegin(GL_QUADS);                //Inicia o desenho do triangulo
    glColor3f(0.5,0,0.5);                    //cor do triangulo
    glVertex2f(Xart2pata3-70,Yart2pata3-35);            //Coordenadas dos pontos do triangulo.
    glVertex2f(Xart2pata3-40,Yart2pata3-15);
    glVertex2f(Xart2pata3+30,Yart2pata3+20);
    glVertex2f(Xart2pata3+30,Yart2pata3+5);
    glEnd();
    
    /*articulação 1 da pata 4*/
    glMatrixMode(GL_MODELVIEW);            //Projeta a imagem na tela.
    glLoadIdentity();                    //Carrega MatrixMode.
    
    glBegin(GL_QUADS);                //Inicia o desenho do triangulo
    glColor3f(1,1,0);                    //cor do triangulo
    glVertex2f(Xart1pata4+40,Yart1pata4+25);            //Coordenadas dos pontos do triangulo.
    glVertex2f(Xart1pata4+40,Yart1pata4+10);
    glVertex2f(Xart1pata4-30,Yart1pata4-25);
    glVertex2f(Xart1pata4-20,Yart1pata4-5);
    glEnd();
    
    /*Desenha articulação 2 da pata 4*/
    glMatrixMode(GL_MODELVIEW);            //Projeta a imagem na tela.
    glLoadIdentity();                    //Carrega MatrixMode.
    
    glBegin(GL_QUADS);
    glColor3f(0.5,0.5,0);
    glVertex2f(Xart2pata4+40,Yart2pata4-15);
    glVertex2f(Xart2pata4+70,Yart2pata4-35);
    glVertex2f(Xart2pata4-30,Yart2pata4+5);
    glVertex2f(Xart2pata4-30,Yart2pata4+20);
    glEnd();
...
void Inicializa(int argc, char **argv) {
    ...
    GLint screen_height = glutGet(GLUT_SCREEN_HEIGHT);          //Tamanho do monitor.
    glutInitWindowSize(windowW,windowH);                        //Tamanho da tela em pixels.
    glutInitWindowPosition((screen_width-windowW)/2, (screen_height-windowH)/2);    //Posicao inicial da janela em pixels ((tam monitor - tam janela)/2 = centro)
